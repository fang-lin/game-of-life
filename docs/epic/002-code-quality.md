...
| # | Story | 状态 |
|---|-------|------|
| 005 | [修复已知 bug 和内存泄漏](../story/STORY-005-fix-bugs-and-leaks.md) | Done |
| 006 | [App.functions 单元测试](../story/STORY-006-test-app-functions.md) | Done |
| 007 | [App 重构为函数组件 + Hooks](../story/STORY-007-refactor-app-to-hooks.md) | Done |
| 008 | [Canvas 重构为函数组件](../story/STORY-008-refactor-canvas-to-hooks.md) | Done |
| 009 | [引入 React Context 替代 prop drilling](../story/STORY-009-react-context.md) | Cancelled |
| 010 | [主题颜色整合与响应式断点修复](../story/STORY-010-theme-consolidation.md) | Done |
| 011 | [无障碍访问改进](../story/STORY-011-accessibility.md) | Done |
