...
- [ ] LifeMap.evolve() 内部使用 HashLife 进行演化
- [ ] 现有 26 个 LifeMap 测试全部通过
- [ ] deadList / bornList 仍然可用（渲染 dead cells 需要）
- [ ] addCell / removeCell / toggleCells / getCells / reset API 不变
- [ ] lint + build 通过
- [ ] 大 pattern（Spacefiller2）性能可感知提升
