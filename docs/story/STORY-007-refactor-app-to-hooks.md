...
- [x] App 改为函数组件
- [x] 移除 `withRouter` HOC，直接使用 `useNavigate`、`useParams`
- [x] 移除所有 `any` 类型
- [x] State 按关注点拆分为多个 `useState`
- [x] 事件监听器使用 `useEffect` + cleanup
- [x] drag listeners 泄漏问题在重构中彻底解决
- [x] 所有现有功能不变
- [x] 现有测试通过
...
|------|---------|
| 2026-05-04 | Story 创建 |
| 2026-05-04 | App refactored to function component with hooks |
